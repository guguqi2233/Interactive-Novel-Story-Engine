...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run the local gameplay module quality gate.")
    parser.add_argument("module_id", help="Gameplay module id to validate.")
